...
<@layout.displayLayout>
  ...
  <div id="kc-header-wrapper">
    <div id="kc-header">${msg("forgotUsernameTitle")}</div>
    <div id="kc-header-subtitle">${msg("forgotUsernameInfo")}</div>
  </div>

  <div id="kc-card">
    <form id="kc-reset-username-form" action="${url.loginResetUrl}" method="post">
      <div class="form-group">
        <label for="firstName" class="form-label">${msg("firstName")}</label>
        <input type="text" id="firstName" class="form-control" name="firstName"
               value="${(auth.attemptedFirstName!'')}" autocomplete="given-name" placeholder="John"/>
      </div>

      <div class="form-group">
        <label for="lastName" class="form-label">${msg("lastName")}</label>
        <input type="text" id="lastName" class="form-control" name="lastName"
               value="${(auth.attemptedLastName!'')}" autocomplete="family-name" placeholder="Doe"/>
      </div>
      ...
      <div id="kc-form-buttons">
        <button type="submit" id="kc-reset-username" class="kc-btn kc-btn-primary">${msg("doResetUsername")}</button>
      </div>
    </form>
