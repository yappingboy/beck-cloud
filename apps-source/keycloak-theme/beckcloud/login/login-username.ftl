...
<@layout.displayLayout>
  ...
  <div id="kc-header-wrapper">
    <div id="kc-header">${msg("loginTitle")}</div>
    <div id="kc-header-subtitle">${msg("loginIdpConfirmUsername")}</div>
  </div>

  <div id="kc-card">
    <form id="kc-login-form" onsubmit="login.disabled = true" action="${url.loginAction}" method="post">
