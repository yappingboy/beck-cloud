...
<@layout.displayLayout>
  ...
  <div id="kc-header-wrapper">
    <div id="kc-header">${msg("webauthnRegisterTitle")}</div>
    <div id="kc-header-subtitle">${msg("webauthnRegisterSubTitle")!msg("webauthnRegisterPasswordlessSubTitle")}</div>
  </div>

  <div id="kc-card">
    <div class="otp-info">
      <p>${msg("webauthnRegisterInstructions")}</p>
    </div>
    ...
    <form id="webauthn_form" action="${url.loginAction}" method="post">
      ...
      <div id="kc-form-buttons">
        <button type="button" id="webauthn-button" class="kc-btn kc-btn-primary">${msg("webauthnRegister")}</button>
      </div>
    </form>
