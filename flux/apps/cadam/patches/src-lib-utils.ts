...
export const PARAMETRIC_MODELS: ModelConfig[] = [
  {
    id: 'ollama/hf.co/unsloth/Qwen3.8-27B-GGUF:Q4_K_M',
    name: 'Qwen 3.8 27B (Ollama)',
    description: 'Local model via BeckCloud Ollama — no external APIs',
    provider: 'Ollama',
    supportsTools: true,
  ...
  {
    id: 'ollama/Qwen3.6-26B-Fable:latest',
    name: 'Qwen 3.6 26B (Ollama)',
    description: 'Local model via BeckCloud Ollama — fast alternative',
    provider: 'Ollama',
    supportsTools: true,
    supportsThinking: false,
